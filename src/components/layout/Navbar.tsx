      ...
      <header className="h-12 border-b border-zinc-800 bg-[#141416] flex items-center justify-between px-4 sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="md:hidden p-1.5 border border-zinc-800 bg-black hover:border-zinc-700 text-text-muted hover:text-text-main transition-all focus:outline-none focus:border-secondary"
